# Validación de Títulos vs Datos JSON Ejemplo (Corregida)

Esta tabla compara los títulos requeridos en `Títulos Numerados tropico.md` con los datos encontrados en `data/carta_natal_tropical_Maria_Blaquier_Buenos_Aires_3-11-1967.json`.
...
*   **REQUIERE LÓGICA ADICIONAL:** Este título implica condiciones complejas o cálculos (como planetas en el Ascendente) que el script actual no realiza.

```markdown
| Título Requerido (Títulos Numerados tropico.md) | Estado (Basado en JSON Ejemplo) |
|---|---|
...
| Aspecto SOL CONJUNCIÓN O CUADRATURA U OPOSICIÓN A JÚPITER Y ADEMÁS SE CUMPLEN ALGUNA DE LAS SIGUIENTES CONDICIONES | REQUIERE LÓGICA ADICIONAL |
...
| SATURNO ESTÁ EN LAS CASAS 1, 4, 7 O 10 O EN CONJUNCIÓN AL SOL, LA LUNA, MERCURIO, VENUS O MARTE Y ADEMÁS URANO ESTÁ EN CASAS 1, 4, 7 O 10, O URANO ESTÁ EN CONJUNCIÓN AL SOL, LA LUNA, MERCURIO, VENUS O MARTE, O SATURNO Y URANO ESTÁN EN CONJUNCIÓN O CUADRATURA U OPOSICIÓN ENTRE SÍ | REQUIERE LÓGICA ADICIONAL |
...
| Aspecto Luna conjunción o sextil o trígono a Júpiter | OK |
| Aspecto Luna cuadratura u oposición a Júpiter | OK |
| Aspecto LUNA ESTÁ EN CONJUNCIÓN O CUADRATURA U OPOSICIÓN A JUPITER Y ADEMÁS SE CUMPLEN LAS SIGUIENTES CONDICIONES | REQUIERE LÓGICA ADICIONAL |
| Aspecto Luna conjunción, cuadratura u oposición Saturno | OK |
| Aspecto Luna sextil o trígono a Saturno | OK |
| Aspecto Luna conjunción o cuadratura u oposición a Urano | OK |
| Aspecto LUNA ESTÁ EN CONJUNCIÓN, CUADRATURA U OPOSICIÓN A URANO Y ADEMÁS SE CUMPLEN LAS SIGUIENTES CONDICIONES | REQUIERE LÓGICA ADICIONAL |
...
| ASCENDENTE ESTÁ EN TAURO Y ADEMÁS SE CUMPLEN LAS SIGUIENTES CONDICIONES | REQUIERE LÓGICA ADICIONAL |
...
| Aspecto MERCURIO ESTÁ EN CONJUNCIÓN O CUADRATURA U OPOSICIÓN A URANO Y ADEMÁS SE CUMPLEN LAS SIGUIENTES CONDICIONES | REQUIERE LÓGICA ADICIONAL |
