# Validación de Títulos vs Datos JSON Ejemplo (Corregida y Actualizada)

Esta tabla compara los títulos requeridos en la versión más reciente de `Títulos Numerados tropico.md` con los datos encontrados en `data/carta_natal_tropical_Maria_Blaquier_Buenos_Aires_3-11-1967.json`.
