...
class InterpretadorRAG:
    ...
    def _get_draconian_narrative_prompt(self, instrucciones_adicionales: str, interpretaciones_combinadas: str) -> str:
        ...
        return (
            ...
            "6. **TONO Y ESTILO ESPECÍFICO:**\n"
            "   **CONCORDANCIA DE GÉNERO:** Usa las formas correctas según el género de la persona (conectada/conectado, llamada/llamado, inspirada/inspirado, etc.). Mantén consistencia en artículos, adjetivos y participios a lo largo de toda la interpretación.\n"
            "   **LENGUAJE ESPECÍFICO:** Usa términos como 'tu alma reconoce', 'desde las profundidades de tu ser', 'impulsos inconscientes', 'memorias ancestrales'. Evita determinismo: en lugar de 'debes hacer X', usa 'tu alma se siente llamada/llamado a...' o 'desde lo más profundo emerge el impulso de...'. Incluye frases como 'en esta encarnación', 'tu patrón evolutivo', 'dimensiones ocultas de tu personalidad'.\n"
            "   **TONO REVELADOR Y VALIDADOR:** Mantén un tono personal, empático y espiritualmente profundo pero accesible. Reconoce que las revelaciones dracónicas pueden resonar profundamente. Incluye frases reconfortantes como 'es natural que esto resuene en lo más hondo de tu ser' o 'esta información puede sentirse como el reconocimiento de algo que siempre has sabido'. Evita jerga excesivamente técnica; usa un lenguaje que inspire y eleve.\n"
            "   **ESTRUCTURA DE PÁRRAFOS:** Organiza en párrafos claros que fluyan como una revelación progresiva. Cada párrafo debe sentirse como el descubrimiento de una nueva capa de comprensión. Usa transiciones suaves que conecten lo consciente con lo inconsciente.\n"
            "   **FRASES REVELADORAS SUGERIDAS:** 'Tu carta dracónica revela una dimensión oculta que pulsa silenciosamente...', 'Desde las profundidades de tu ser emergen patrones que han moldeado tu camino...', 'Esta configuración dracónica se manifiesta cuando...', 'Tu alma reconoce este patrón y lo expresa a través de...', 'Puedes haber experimentado/experimentada esto como una sensación de que...', 'Es probable que sientas una resonancia profunda con...', 'Al reconocer estos patrones dracónicos, tienes la oportunidad de...'\n"

            "7. **EXTENSIÓN COMPREHENSIVA:** El informe debe ser profundo y detallado (mínimo 2000 palabras) pero dividido en secciones que se digieren fácilmente. Cada elemento importante del alma merece espacio para ser explorado adecuadamente.\n"

            "8. **VALIDACIÓN DE CONTENIDO:** Antes de escribir, verifica que cada elemento mencionado corresponda exactamente a los títulos e información proporcionada en las interpretaciones individuales. No incluyas elementos astrológicos que no aparezcan en el material fuente.\n"
